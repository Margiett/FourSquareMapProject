...
protocol SearchButtonPressedDelegate : AnyObject {
...
class SearchViewController: UIViewController {
    ...
    weak var delegate: SearchButtonPressedDelegate?
    ...
    private var allLocations = [Venue]() {
        didSet{
            DispatchQueue.main.async {
                self.delegate?.searchButtonPressed(venue: self.allLocations)
    ...
    @objc private func searchButtonPressed() {
        ...
        delegate?.searchButtonPressed(venue: allLocations)
    }
}
...
//        present(UINavidetailVC, animated: true)
    }
