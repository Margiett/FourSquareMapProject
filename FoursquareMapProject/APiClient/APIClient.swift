...
struct VenueAPIClient{
    static func getVenues(city: String, venue: String, completion: @escaping (Result <[Venue],AppError>) -> ()){
        ...
        let newEndpointURL = "https://api.foursquare.com/v2/venues/search?client_id=\(APIKeys.ClientId)&client_secret=\(APIKeys.ClientSecret)&v=20210102&near=\(cityFinal)&intent=browse&radius=1500&query=\(venueFinal)&limit=20"
